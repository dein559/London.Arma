/*
resource "aws_route_table" "private-F" {
...
resource "aws_route_table" "public-F" {
  vpc_id = aws_vpc.app1-vpc-F-Hong-Kong.id
...
resource "aws_route_table_association" "private-ap-east-1a" {
  ...
  route_table_id = aws_route_table.private-F.id
}
...
resource "aws_route_table_association" "public-ap-east-1a" {
  ...
  route_table_id = aws_route_table.public-F.id
}
